        ...
        >
            ...
            <div className="relative aspect-[16/10] overflow-hidden">
                <Image
                    ...
                    className="object-cover transition-all duration-1000 group-hover:scale-105 group-hover:rotate-1 opacity-70 group-hover:opacity-30 grayscale-[0.2] group-hover:grayscale-0"
                />
